...
export const howItWorks = [
  ...
  },
  {
    ...
    copy: "Start from the 5 USDT minimum deposit and check the active deposit bonus.",
  },
  {
  ...
  },
  {
    ...
    copy: "Confirm your slip, follow the match, and review withdrawal status from 10 USDT.",
  },
];

export const platformOperations = [
  { label: "Deposit bonus", value: "1 USDT" },
  { label: "Minimum deposit", value: "5 USDT" },
  { label: "Daily percentage", value: "3-4%" },
  { label: "Minimum withdrawal", value: "10 USDT" },
];
...
export const bonuses = [
  {
    ...
    copy: "New users can start with the 1 USDT deposit bonus shown in EFC platform operations.",
  },
  {
...
export const invitationTiers = [
  { members: "10", reward: "10 USDT" },
  { members: "20", reward: "30 USDT" },
  { members: "30", reward: "50 USDT" },
  { members: "50", reward: "70 USDT" },
  { members: "80", reward: "100 USDT" },
  { members: "100", reward: "150 USDT" },
];
