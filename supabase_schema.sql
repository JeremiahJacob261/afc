...
CREATE TABLE IF NOT EXISTS admin_settings (
  ...
  membership_balance_threshold DECIMAL(15, 3) NOT NULL DEFAULT 1.667 CHECK (
...
ALTER TABLE admin_settings ADD COLUMN IF NOT EXISTS membership_balance_threshold DECIMAL(15, 3) NOT NULL DEFAULT 1.667 CHECK (membership_balance_threshold >= 0);
...
VALUES (1, 3.000, 1.667, 10.000, 100000.000, 100.000, '{}', 7.000, TRUE, 'Withdrawals are temporarily unavailable. Please try again later.')
...
REVOKE ALL ON FUNCTION public.place_bet_with_expected_odd_atomic(TEXT, TEXT, TEXT, NUMERIC, NUMERIC, UUID) FROM PUBLIC;
...
GRANT EXECUTE ON FUNCTION public.place_bet_with_expected_odd_atomic(TEXT, TEXT, TEXT, NUMERIC, NUMERIC, UUID) TO service_role;
