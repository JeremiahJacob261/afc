          ...
          <Stack direction="column" spacing={1} style={{ background: '#10284D', width: '100%', maxWidth: '450px', padding: '12px', borderRadius: '10px' }}>
            ...
            <Stack direction='row' justifyContent='space-between' alignItems='center' flexWrap='wrap' gap={1} >
              <Stack sx={{ minWidth: 0, flex: '1 1 150px' }}>
                ...
                <Typography style={{ fontSize: '18px', fontWeight: '500', fontFamily: 'Poppins, sans-serif', minHeight: '24px', padding: '1px', width: '100%', color: '#E9E5DA', overflowWrap: 'anywhere' }}>{Math.floor(Number(balance) || 0).toLocaleString()} FCFA</Typography>
              </Stack>
