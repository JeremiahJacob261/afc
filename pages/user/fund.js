...
export default function Funds() {
  const router = useRouter();
    return(
        ...
        <Button variant='contained' sx={{position:'absolute',bottom:90,fontFamily:'Poppins,sans-serif',color:'#E5E7EB',background:'#03045E',padding:'8px',width:'343px',height:'50px'}} onClick={()=>{
