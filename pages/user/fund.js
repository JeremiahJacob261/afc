...
export default function Funds() {
  const router = useRouter();
    ...
    return(
        ...
        <motion.div whileTap={{ scale:1.05 }} style={{ cursor:'pointer',border:'0.6px solid #373636',display:'flex',flexDirection:'row',cursor:'pointer', alignItems:'center',borderRadius:'8px', justifyContent:'center',   color: "#CACACA", height: '50px', background: '#D4AF37',minWidth:'310px',padding:'12px' }} onClick={()=>{
          handleOpenx()
