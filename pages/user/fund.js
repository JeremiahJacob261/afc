  ...
  const router = useRouter();
    ...
    return(
        ...
        <Stack direction='column' justifyContent='center' alignItems='center' sx={{minHeight:'95vh',padding:'12px',position:'relative'}} spacing={3}>
         ...
         <Typography id="modal-modal-description" sx={{color:'#E9E5DA',textAlign:'center',fontFamily:'Poppins,sans-serif',fontSize:'18px',fontWeight:'300'}}>
         Deposit money into your account in 3 easy steps with any payment method of your choice
    </Typography>
            </Stack>
        <motion.div whileTap={{ scale:1.05 }} style={{ cursor:'pointer',border:'0.6px solid #10284D',display:'flex',flexDirection:'row',cursor:'pointer', alignItems:'center',borderRadius:'8px', justifyContent:'center',   color: "#06101F", height: '50px', background: '#1BB6FF',minWidth:'310px',padding:'12px' }} onClick={()=>{
          handleOpenx()
