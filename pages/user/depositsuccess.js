  ...
  useEffect(()=>{
    ...
    return(
        ...
        <Stack direction='column' alignItems='center' justifyContent='center' sx={{minHeight:'90vh',padding:'12px',position:'relative'}}>
         ...
         <Typography sx={{fontSize:'18px',fontWeight:'600',color:'black'}}>Deposit Successful</Typography>
        ...
        <Button variant='contained' sx={{position:'absolute',bottom:100,fontFamily:'Poppins,sans-serif',color:'#E5E7EB',background:'#03045E',padding:'8px',width:'343px',height:'50px'}} onClick={()=>{
