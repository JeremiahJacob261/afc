          ...
          <Stack spacing={1} sx={{ background: 'inherit', padding: '8px', borderRadius: '5px' }}>
            ...
            <Stack style={{ padding: '8px', borderRadius: '10px', display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
              <Stack>
                ...
                <Typography style={{ fontSize: '18px', fontWeight: '500', fontFamily: 'Poppins, sans-serif', height: '24px', padding: '1px', width: '100%', color: '#E9E5DA' }}>{Math.floor(Number(balance) || 0).toLocaleString()} FCFA</Typography>
              </Stack>
