  ...
  return (
    <div stylle={{minHeight:'80vh'}}>
      <Stack direction="row" justifyContent="left">
        <CloseIcon style={{ color: '#CACACA', width: '30px', height: '30px', margin: '8px' }}
        onClick={()=>{
      ...
      <Stack sx={{padding:'8px'}}>
      {
        ...
        <AccordionSummary
          ...
          id="panel1bh-header"
        >
          <Typography sx={{ width: '33%', flexShrink: 0,color:'#CACACA',fontFamily:'Poppins,sans-serif' }}>
            {f.Question}
          </Typography>
          <Typography sx={{ color: '#CACACA' }}></Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography sx={{ color: '#CACACA',fontWeight:'100',fontSize:'15px',fontFamily:'Poppins,sans-serif' }}>
           {f.Answer}
          </Typography>
        </AccordionDetails>
      </Accordion>
