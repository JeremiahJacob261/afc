        ...
        return (
            <Cover>
                <Stack style={{ width: "100%", minHeight: '100vh', background: '#06101F', padding: '24px' }} alignItems="center" justifyContent="center" spacing={2}>
                    ...
                    <Button variant="contained" onClick={() => router.push('/dashboard/matches')} sx={{ background: '#1BB6FF', color: '#06101F' }}>
                        Back to matches
                    </Button>
                </Stack>
            </Cover>
    ...
    return (
        <Cover>
            ...
            <Stack style={{ width: "100%", minHeight: '100vh', background: '#06101F' }} alignItems="center">
                ...
                <Stack direction='row' alignItems='left' justifyContent='left' spacing={1} sx={{ width: '100%', margin: '5px' }} onClick={() => { router.push('/dashboard/matches') }}>
