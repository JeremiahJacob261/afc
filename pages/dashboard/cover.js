      ...
      <React.Fragment >
        ...
        >
          <Stack direction='column' sx={{ padding: '12px', background: '#06101F', height: '100%', position: 'fixed' }}>
            ...
            <Stack direction='column' >
              <Link href='/dashboard/matches' style={{ textDecoration: "none", color: '#E9E5DA', cursor: 'pointer' }}>
              ...
              <Link href='/dashboard/bets' style={{ textDecoration: "none", color: '#E9E5DA', cursor: 'pointer' }}>
                <Stack direction='row' alignItems='center' justifyContent='space-between' sx={{ width: '224px', height: '41px' }}>
                  <Stack direction='row' spacing={2}>
              ...
              <Link href='/dashboard/fund' style={{ textDecoration: "none", color: '#E9E5DA', cursor: 'pointer' }}>
                <Stack direction='row' alignItems='center' justifyContent='space-between' sx={{ width: '224px', height: '41px' }}>
                  <Stack direction='row' spacing={2}>
              ...
              <Link href='/dashboard/withdraw' style={{ textDecoration: "none", color: '#E9E5DA', cursor: 'pointer' }}>
                <Stack direction='row' alignItems='center' justifyContent='space-between' sx={{ width: '224px', height: '41px' }}>
                  <Stack direction='row' spacing={2}>
              ...
              <Link href='/dashboard/account' style={{ textDecoration: "none", color: '#E9E5DA', cursor: 'pointer' }}>
                <Stack direction='row' alignItems='center' justifyContent='space-between' sx={{ width: '224px', height: '41px' }}>
                  <Stack direction='row' spacing={2}>
