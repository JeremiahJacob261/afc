...
export default function Home() {
  ...
  return (
    <div className={styles.container} style={{ background: "#03045E", width: "100%", minHeight: "750px", color: "#E5E7EB", opacity: "0.9", padding: "1px", backdropFilter: "blur(8px)" }}>
      <Head>
        <title>ATALANTA FOOTBALL CLUB (BFC)</title>
      ...
      <Stack direction="column" justifyContent='center' alignItems="center" spacing={5}>
        ...
        <div style={{ background: '#1A1B72', padding: '8px', borderRadius: '5px' }}>
          ...
          {t('invitation_bonus_description')}</Typography>
            <Link href="/register/000208" style={{ textDecoration: 'none' }}>
          <Button style={{ border: '1px solid #03045E', color: '#E5E7EB' }}>{t('unlock_rewards')}</Button></Link>
        </div>
        {
          //end
        }
        <div style={{ background: '#1A1B72', padding: '8px', borderRadius: '5px' }}>
          ...
          {t('betting_markets')}
            ...
            <Link href="/register/000208" style={{ textDecoration: 'none' }}> 
             <Button style={{ fontFamily: 'Poppins, sans-serif', background: '#03045E', color: '#E5E7EB', width: '100%' }}>{t('try_our_odds')}</Button>
        </Link>
        </div>
        ...
        <div style={{ background: '#1A1B72', padding: '8px', borderRadius: '5px' }}>
          ...
          <Link href="/register/000208" style={{ textDecoration: 'none' }}>  <Button style={{ fontFamily: 'Poppins, sans-serif', background: '#03045E', color: '#E5E7EB', width: '100%' }}>{t('join_now')}</Button>
        </Link>
        </div>
        ...
        <div style={{ background: '#1A1B72', padding: '8px', borderRadius: '5px' }}>
          ...
          {t('build_your_team')}</Typography>
            <Link href="/register/000208" style={{ textDecoration: 'none' }}>  <Button style={{ fontFamily: 'Poppins, sans-serif', background: '#03045E', color: '#E5E7EB', width: '100%', padding: '8px' }}>{t('build_team')}</Button>
        </Link>
        </div>
